...
VALUES
    ...
    select * FROM students 
     WHERE country = 'USA' OR course = 'Australia';

    select * FROM students 
     WHERE (country = 'USA' OR course = 'Australia') AND age = 20;
...
SELECT COALESCE(email, 'Email Not Exists') as "Email", first_name, last_name FROM students;
...
SELECT * FROM students
    WHERE dob BETWEEN '2002-01-01' and '2004-01-01' ORDER BY dob DESC;
...
UPDATE students set email = 'new@example.com', age = 25, course = 'Math'
    WHERE student_id = 5
